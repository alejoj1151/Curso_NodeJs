...
const guardarCxU = () => {
    ...
    fs.writeFile('CursoxUsuario.json', datos, (err) => {
        if (err) throw (err);
            console.log('Cursos por usuario guardados exitosamente')
    })
}
...
const crearC = (curso) => {
    ...
    if (!duplicado) {
        ...
        guardarC();
            return (`<div class="alert alert-success" role="alert">Curso creado exitosamente</div>`);
    } else
            return ('<div class="alert alert-danger" role="alert">Ya existe otro curso con esta identificación</div>');
...
const crearU = (user) => {
    ...
    if (!duplicado) {
        ...
        `<div class="alert alert-success" role="alert">
            Se crea el usuario exitosamente y se registra en el curso
        </div>`)
    } else {
        ...
        if (!cursoduplicado) {
           ...
           <div class="alert alert-warning" role="alert">
            Ya existe el usuario con este documento, pero se registra en el curso
            </div>
            `)
        } else {
            return (
                `<div class="alert alert-danger" role="alert">
                Ya existe el usuario con el documento y con este curso registrados
            </div>`);
        }
    }
